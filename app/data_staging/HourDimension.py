...
class HourDimension(object):
    ...
    def populate():
        """
        Does a historic load into the hour dimension
        :return: None
        """
        ...
        for i in range(delta.days + 1):
            ...
            year = date.year
            is_weekend = HourDimension.is_weekend(day_of_week)
            is_holiday, holiday_name = HourDimension.is_holiday(date)
        ...
        HourDimensionDAL.insert_many(entities)
